...
const Project = () => {
	const projectCards = [
		{
			...
			description: 'The solution allows merchants to accept online payments on websites, applications, social networks, using popular non-cash payment methods today: Domestic payment cards, International cards, Transfer money, E-wallet, Buy now pay later, Installments...',
	...
	return (
		<div id="blog-project" className="pt-[5rem] pb-[3rem] bg-gray-900">
